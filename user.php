                            ...
                            <div class="col-lg-8 col-xl-6">
                                <form id="loginForm" action="addaccount.php" method="post">
                                    ...
                                    <div class="form-floating mb-3">
                                        ...
                                        <script>
                                            var q = document.getElementById("pwd2");
                                            
                                            document.getElementById("pwdtag2").addEventListener("click",function(){
                                                if (q.type == "password"){
                                                    q.type = "text";
                                                    this.innerText = "隱藏密碼";
                                                }
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name='email' id="email" type="text" placeholder="email" value="<?php echo $_SESSION['email'];?>" required/>
                                        <label for="email">E-mail</label>
                                    </div>
                                    
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name='name' id="name" type="text" value="<?php echo $_SESSION['name'];?>" placeholder="姓名" required/>
                                        <label for="name">姓名</label>
                                    </div>
                                    
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name='phone' id="phone" type="text" value="<?php echo $_SESSION['phone'];?>" placeholder="電話" required/>
                                    ...
                                    <!-- Submit Button-->
                                    <div class="d-grid"><button class="btn btn-primary btn-lg" id="submitButton" type="submit">變更</button></div>
                                </form>
                            </div>
                        </div>
                    </div>
